...
"abs" = [
    0b01011110_00100000_10111000_00000000 = [V, V] => [Unimp];
    0b00001110_00100000_10111000_00000000 = [Unimp] => [Unimp];
]
"adc" = [
...
"add" = [
    ...
    // ADD (vector)
    0b01011110_00100000_10000100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_10000100_00000000 = [Unimp] => [Unimp];
]
"addhn" = [
    0b00001110_00100000_01000000_00000000 = [Unimp] => [Unimp];
]
"addhn2" = [
    0b01001110_00100000_01000000_00000000 = [Unimp] => [Unimp];
]
"addp" = [
    // ADDP (scalar)
    0b01011110_00110001_10111000_00000000 = [Unimp] => [Unimp];
    // ADDP (vector)
    0b00001110_00100000_10111100_00000000 = [Unimp] => [Unimp];
]
"adds" = [
...
"addv" = [
    0b00001110_00110001_10111000_00000000 = [V, VWild] => [Unimp];
]
"adr" = [
...
"aesd" = [
    0b01001110_00101000_01011000_00000000 = [VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16)] => [Unimp];
]
"aese" = [
    0b01001110_00101000_01001000_00000000 = [VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16)] => [Unimp];
]
"aesimc" = [
    0b01001110_00101000_01111000_00000000 = [VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16)] => [Unimp];
]
"aesmc" = [
    0b01001110_00101000_01101000_00000000 = [VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16)] => [Unimp];
]
"and" = [
    // AND (vector)
    0b00001110_00100000_00011100_00000000 = [Unimp] => [Unimp];
    // AND (immediate)
...
"bcax" = [
    0b11001110_00100000_00000000_00000000 = [VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16)] => [Unimp];
]
"bfc" = [
...
"bic" = [
    ...
    0b00101111_00000000_10010100_00000000 = [Unimp] => [Unimp];
    0b00101111_00000000_00010100_00000000 = [Unimp] => [Unimp];
    // BIC (vector, register)
    0b00001110_01100000_00011100_00000000 = [Unimp] => [Unimp];
...
"bif" = [
    0b00101110_11100000_00011100_00000000 = [Unimp] => [Unimp];
]
"bit" = [
    0b00101110_10100000_00011100_00000000 = [Unimp] => [Unimp];
]
"bl" = [
...
"bsl" = [
    0b00101110_01100000_00011100_00000000 = [Unimp] => [Unimp];
]
"cas" = [
...
"casp" = [
    0b00001000_00100000_01111100_00000000 = [W, W, W, W, RefBase] => [R(16), Unimp, R(0), Unimp, R(5)];
    0b01001000_00100000_01111100_00000000 = [X, X, X, X, RefBase] => [R(16), Unimp, R(0), Unimp, R(5)];
]
"caspa" = [
    0b00001000_01100000_01111100_00000000 = [W, W, W, W, RefBase] => [R(16), Unimp, R(0), Unimp, R(5)];
    0b01001000_01100000_01111100_00000000 = [X, X, X, X, RefBase] => [R(16), Unimp, R(0), Unimp, R(5)];
]
"caspal" = [
    0b00001000_01100000_11111100_00000000 = [W, W, W, W, RefBase] => [R(16), Unimp, R(0), Unimp, R(5)];
    0b01001000_01100000_11111100_00000000 = [X, X, X, X, RefBase] => [R(16), Unimp, R(0), Unimp, R(5)];
]
"caspl" = [
    0b00001000_00100000_11111100_00000000 = [W, W, W, W, RefBase] => [R(16), Unimp, R(0), Unimp, R(5)];
    0b01001000_00100000_11111100_00000000 = [X, X, X, X, RefBase] => [R(16), Unimp, R(0), Unimp, R(5)];
]
"cbnz" = [
...
"cls" = [
    // CLS (vector)
    0b00001110_00100000_01001000_00000000 = [Unimp] => [Unimp];
    // CLS
...
"clz" = [
    // CLZ (vector)
    0b00101110_00100000_01001000_00000000 = [Unimp] => [Unimp];
    // CLZ
...
"cmeq" = [
    // CMEQ (register)
    0b01111110_00100000_10001100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_10001100_00000000 = [Unimp] => [Unimp];
    // CMEQ (zero)
    0b01011110_00100000_10011000_00000000 = [V, V, LitInt(0)] => [Unimp];
    0b00001110_00100000_10011000_00000000 = [Unimp] => [Unimp];
]
"cmge" = [
    // CMGE (register)
    0b01011110_00100000_00111100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_00111100_00000000 = [Unimp] => [Unimp];
    // CMGE (zero)
    0b01111110_00100000_10001000_00000000 = [V, V, LitInt(0)] => [Unimp];
    0b00101110_00100000_10001000_00000000 = [Unimp] => [Unimp];
]
"cmgt" = [
    // CMGT (register)
    0b01011110_00100000_00110100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_00110100_00000000 = [Unimp] => [Unimp];
    // CMGT (zero)
    0b01011110_00100000_10001000_00000000 = [V, V, LitInt(0)] => [Unimp];
    0b00001110_00100000_10001000_00000000 = [Unimp] => [Unimp];
]
"cmhi" = [
    0b01111110_00100000_00110100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_00110100_00000000 = [Unimp] => [Unimp];
]
"cmhs" = [
    0b01111110_00100000_00111100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_00111100_00000000 = [Unimp] => [Unimp];
]
"cmle" = [
    0b01111110_00100000_10011000_00000000 = [V, V, LitInt(0)] => [Unimp];
    0b00101110_00100000_10011000_00000000 = [Unimp] => [Unimp];
]
"cmlt" = [
    0b01011110_00100000_10101000_00000000 = [V, V, LitInt(0)] => [Unimp];
    0b00001110_00100000_10101000_00000000 = [Unimp] => [Unimp];
]
"cmn" = [
...
"cmtst" = [
    0b01011110_00100000_10001100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_10001100_00000000 = [Unimp] => [Unimp];
]
"cneg" = [
...
"cnt" = [
    0b00001110_00100000_01011000_00000000 = [Unimp] => [Unimp];
]
"cpp" = [
...
"dup" = [
    // DUP (element)
    0b01011110_00000000_00000100_00000000 = [Unimp] => [Unimp];
    0b00001110_00000000_00000100_00000000 = [Unimp] => [Unimp];
    // DUP (general)
    0b00001110_00000000_00001100_00000000 = [Unimp] => [Unimp];
]
"dvp" = [
...
"eor" = [
    // EOR (vector)
    0b00101110_00100000_00011100_00000000 = [Unimp] => [Unimp];
    // EOR (immediate)
...
"eor3" = [
    0b11001110_00000000_00000000_00000000 = [VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16), VSizedStatic(BYTE, 16)] => [Unimp];
]
"eret" = [
...
"ext" = [
    0b00101110_00000000_00000000_00000000 = [Unimp] => [Unimp];
]
"extr" = [
...
"fabd" = [
    ...
    0b01111110_10100000_11010100_00000000 = [V, V, V] => [Unimp];
    0b00101110_11000000_00010100_00000000 = [Unimp] => [Unimp];
    0b00101110_10100000_11010100_00000000 = [Unimp] => [Unimp];
]
"fabs" = [
    // FABS (vector)
    0b00001110_11111000_11111000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11111000_00000000 = [Unimp] => [Unimp];
    // FABS (scalar)
...
"facge" = [
    ...
    0b01111110_00100000_11101100_00000000 = [V, V, V] => [Unimp];
    0b00101110_01000000_00101100_00000000 = [Unimp] => [Unimp];
    0b00101110_00100000_11101100_00000000 = [Unimp] => [Unimp];
]
"facgt" = [
    0b01111110_11000000_00101100_00000000 = [H, H, H] => [R(0), R(5), R(16)];
    0b01111110_10100000_11101100_00000000 = [V, V, V] => [Unimp];
    0b00101110_11000000_00101100_00000000 = [Unimp] => [Unimp];
    0b00101110_10100000_11101100_00000000 = [Unimp] => [Unimp];
]
"fadd" = [
    // FADD (vector)
    0b00001110_01000000_00010100_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_11010100_00000000 = [Unimp] => [Unimp];
    // FADD (scalar)
...
"faddp" = [
    // FADDP (scalar)
    0b01011110_00110000_11011000_00000000 = [Unimp] => [Unimp];
    0b01111110_00110000_11011000_00000000 = [Unimp] => [Unimp];
    // FADDP (vector)
    0b00101110_01000000_00010100_00000000 = [Unimp] => [Unimp];
    0b00101110_00100000_11010100_00000000 = [Unimp] => [Unimp];
]
"fcadd" = [
    0b00101110_00000000_11100100_00000000 = [Unimp] => [Unimp];
]
"fccmp" = [
...
"fcmeq" = [
    ...
    0b01011110_00100000_11100100_00000000 = [V, V, V] => [Unimp];
    0b00001110_01000000_00100100_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_11100100_00000000 = [Unimp] => [Unimp];
    // FCMEQ (zero)
    0b01011110_11111000_11011000_00000000 = [H, H, LitFloat(0.0)] => [R(0), R(5)];
    0b01011110_10100000_11011000_00000000 = [V, V, LitFloat(0.0)] => [Unimp];
    0b00001110_11111000_11011000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11011000_00000000 = [Unimp] => [Unimp];
]
"fcmge" = [
    // FCMGE (register)
    0b01111110_01000000_00100100_00000000 = [H, H, H] => [R(0), R(5), R(16)];
    0b01111110_00100000_11100100_00000000 = [V, V, V] => [Unimp];
    0b00101110_01000000_00100100_00000000 = [Unimp] => [Unimp];
    0b00101110_00100000_11100100_00000000 = [Unimp] => [Unimp];
    // FCMGE (zero)
    0b01111110_11111000_11001000_00000000 = [H, H, LitFloat(0.0)] => [R(0), R(5)];
    0b01111110_10100000_11001000_00000000 = [V, V, LitFloat(0.0)] => [Unimp];
    0b00101110_11111000_11001000_00000000 = [Unimp] => [Unimp];
    0b00101110_10100000_11001000_00000000 = [Unimp] => [Unimp];
]
"fcmgt" = [
    // FCMGT (register)
    0b01111110_11000000_00100100_00000000 = [H, H, H] => [R(0), R(5), R(16)];
    0b01111110_10100000_11100100_00000000 = [V, V, V] => [Unimp];
    0b00101110_11000000_00100100_00000000 = [Unimp] => [Unimp];
    0b00101110_10100000_11100100_00000000 = [Unimp] => [Unimp];
    // FCMGT (zero)
    0b01011110_11111000_11001000_00000000 = [H, H, LitFloat(0.0)] => [R(0), R(5)];
    0b01011110_10100000_11001000_00000000 = [V, V, LitFloat(0.0)] => [Unimp];
    0b00001110_11111000_11001000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11001000_00000000 = [Unimp] => [Unimp];
]
"fcmla" = [
    // FCMLA (by element)
    0b00101111_01000000_00010000_00000000 = [Unimp] => [Unimp];
    0b00101111_10000000_00010000_00000000 = [Unimp] => [Unimp];
    // FCMLA
    0b00101110_00000000_11000100_00000000 = [Unimp] => [Unimp];
]
"fcmle" = [
    0b01111110_11111000_11011000_00000000 = [H, H, LitFloat(0.0)] => [R(0), R(5)];
    0b01111110_10100000_11011000_00000000 = [V, V, LitFloat(0.0)] => [Unimp];
    0b00101110_11111000_11011000_00000000 = [Unimp] => [Unimp];
    0b00101110_10100000_11011000_00000000 = [Unimp] => [Unimp];
]
"fcmlt" = [
    0b01011110_11111000_11101000_00000000 = [H, H, LitFloat(0.0)] => [R(0), R(5)];
    0b01011110_10100000_11101000_00000000 = [V, V, LitFloat(0.0)] => [Unimp];
    0b00001110_11111000_11101000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11101000_00000000 = [Unimp] => [Unimp];
]
"fcmp" = [
...
"fcvtas" = [
    ...
    0b01011110_00100001_11001000_00000000 = [V, V] => [Unimp];
    0b00001110_01111001_11001000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100001_11001000_00000000 = [Unimp] => [Unimp];
    // FCVTAS (scalar)
...
"fcvtau" = [
    ...
    0b01111110_00100001_11001000_00000000 = [V, V] => [Unimp];
    0b00101110_01111001_11001000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_11001000_00000000 = [Unimp] => [Unimp];
    // FCVTAU (scalar)
...
"fcvtl" = [
    0b00001110_00100001_01111000_00000000 = [Unimp] => [Unimp];
]
"fcvtl2" = [
    0b01001110_00100001_01111000_00000000 = [Unimp] => [Unimp];
]
"fcvtms" = [
    // FCVTMS (vector)
    0b01011110_01111001_10111000_00000000 = [H, H] => [R(0), R(5)];
    0b01011110_00100001_10111000_00000000 = [V, V] => [Unimp];
    0b00001110_01111001_10111000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100001_10111000_00000000 = [Unimp] => [Unimp];
    // FCVTMS (scalar)
...
"fcvtmu" = [
    ...
    0b01111110_00100001_10111000_00000000 = [V, V] => [Unimp];
    0b00101110_01111001_10111000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_10111000_00000000 = [Unimp] => [Unimp];
    // FCVTMU (scalar)
...
"fcvtn" = [
    0b00001110_00100001_01101000_00000000 = [Unimp] => [Unimp];
]
"fcvtn2" = [
    0b01001110_00100001_01101000_00000000 = [Unimp] => [Unimp];
]
"fcvtns" = [
    // FCVTNS (vector)
    0b01011110_01111001_10101000_00000000 = [H, H] => [R(0), R(5)];
    0b01011110_00100001_10101000_00000000 = [V, V] => [Unimp];
    0b00001110_01111001_10101000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100001_10101000_00000000 = [Unimp] => [Unimp];
    // FCVTNS (scalar)
...
"fcvtnu" = [
    ...
    0b01111110_00100001_10101000_00000000 = [V, V] => [Unimp];
    0b00101110_01111001_10101000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_10101000_00000000 = [Unimp] => [Unimp];
    // FCVTNU (scalar)
...
"fcvtps" = [
    ...
    0b01011110_10100001_10101000_00000000 = [V, V] => [Unimp];
    0b00001110_11111001_10101000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100001_10101000_00000000 = [Unimp] => [Unimp];
    // FCVTPS (scalar)
...
"fcvtpu" = [
    ...
    0b01111110_10100001_10101000_00000000 = [V, V] => [Unimp];
    0b00101110_11111001_10101000_00000000 = [Unimp] => [Unimp];
    0b00101110_10100001_10101000_00000000 = [Unimp] => [Unimp];
    // FCVTPU (scalar)
...
"fcvtxn" = [
    0b01111110_00100001_01101000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_01101000_00000000 = [Unimp] => [Unimp];
]
"fcvtxn2" = [
    0b01101110_00100001_01101000_00000000 = [Unimp] => [Unimp];
]
"fcvtzs" = [
    // FCVTZS (vector, fixed-point)
    0b01011111_00000000_11111100_00000000 = [V, V, Imm] => [Unimp];
    0b00001111_00000000_11111100_00000000 = [Unimp] => [Unimp];
    // FCVTZS (vector, integer)
    0b01011110_11111001_10111000_00000000 = [H, H] => [R(0), R(5)];
    0b01011110_10100001_10111000_00000000 = [V, V] => [Unimp];
    0b00001110_11111001_10111000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100001_10111000_00000000 = [Unimp] => [Unimp];
...
"fcvtzu" = [
    ...
    0b01111111_00000000_11111100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_11111100_00000000 = [Unimp] => [Unimp];
    // FCVTZU (vector, integer)
    0b01111110_11111001_10111000_00000000 = [H, H] => [R(0), R(5)];
    0b01111110_10100001_10111000_00000000 = [V, V] => [Unimp];
    0b00101110_11111001_10111000_00000000 = [Unimp] => [Unimp];
    0b00101110_10100001_10111000_00000000 = [Unimp] => [Unimp];
...
"fdiv" = [
    // FDIV (vector)
    0b00101110_01000000_00111100_00000000 = [Unimp] => [Unimp];
    0b00101110_00100000_11111100_00000000 = [Unimp] => [Unimp];
    // FDIV (scalar)
...
"fmax" = [
    // FMAX (vector)
    0b00001110_01000000_00110100_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_11110100_00000000 = [Unimp] => [Unimp];
    // FMAX (scalar)
...
"fmaxnm" = [
    // FMAXNM (vector)
    0b00001110_01000000_00000100_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_11000100_00000000 = [Unimp] => [Unimp];
    // FMAXNM (scalar)
...
"fmaxnmp" = [
    // FMAXNMP (scalar)
    0b01011110_00110000_11001000_00000000 = [Unimp] => [Unimp];
    0b01111110_00110000_11001000_00000000 = [Unimp] => [Unimp];
    // FMAXNMP (vector)
    0b00101110_01000000_00000100_00000000 = [Unimp] => [Unimp];
    0b00101110_00100000_11000100_00000000 = [Unimp] => [Unimp];
]
"fmaxnmv" = [
    0b00001110_00110000_11001000_00000000 = [H, VSized(WORD)] => [R(0), R(5), Unimp];
    0b00101110_00110000_11001000_00000000 = [Unimp] => [Unimp];
]
"fmaxp" = [
    // FMAXP (scalar)
    0b01011110_00110000_11111000_00000000 = [Unimp] => [Unimp];
    0b01111110_00110000_11111000_00000000 = [Unimp] => [Unimp];
    // FMAXP (vector)
    0b00101110_01000000_00110100_00000000 = [Unimp] => [Unimp];
    0b00101110_00100000_11110100_00000000 = [Unimp] => [Unimp];
]
"fmaxv" = [
    0b00001110_00110000_11111000_00000000 = [H, VSized(WORD)] => [R(0), R(5), Unimp];
    0b00101110_00110000_11111000_00000000 = [Unimp] => [Unimp];
]
"fmin" = [
    // FMIN (vector)
    0b00001110_11000000_00110100_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11110100_00000000 = [Unimp] => [Unimp];
    // FMIN (scalar)
...
"fminnm" = [
    // FMINNM (vector)
    0b00001110_11000000_00000100_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11000100_00000000 = [Unimp] => [Unimp];
    // FMINNM (scalar)
...
"fminnmp" = [
    // FMINNMP (scalar)
    0b01011110_10110000_11001000_00000000 = [Unimp] => [Unimp];
    0b01111110_10110000_11001000_00000000 = [Unimp] => [Unimp];
    // FMINNMP (vector)
    0b00101110_11000000_00000100_00000000 = [Unimp] => [Unimp];
    0b00101110_10100000_11000100_00000000 = [Unimp] => [Unimp];
]
"fminnmv" = [
    0b00001110_10110000_11001000_00000000 = [H, VSized(WORD)] => [R(0), R(5), Unimp];
    0b00101110_10110000_11001000_00000000 = [Unimp] => [Unimp];
]
"fminp" = [
    // FMINP (scalar)
    0b01011110_10110000_11111000_00000000 = [Unimp] => [Unimp];
    0b01111110_10110000_11111000_00000000 = [Unimp] => [Unimp];
    // FMINP (vector)
    0b00101110_11000000_00110100_00000000 = [Unimp] => [Unimp];
    0b00101110_10100000_11110100_00000000 = [Unimp] => [Unimp];
]
"fminv" = [
    0b00001110_10110000_11111000_00000000 = [H, VSized(WORD)] => [R(0), R(5), Unimp];
    0b00101110_10110000_11111000_00000000 = [Unimp] => [Unimp];
]
"fmla" = [
    // FMLA (by element)
    0b01011111_00000000_00010000_00000000 = [H, H, VLanes(WORD)] => [Unimp];
    0b01011111_10000000_00010000_00000000 = [V, V, Unimp] => [Unimp];
    0b00001111_00000000_00010000_00000000 = [Unimp] => [Unimp];
    0b00001111_10000000_00010000_00000000 = [Unimp] => [Unimp];
    // FMLA (vector)
    0b00001110_01000000_00001100_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_11001100_00000000 = [Unimp] => [Unimp];
]
"fmlal" = [
    // FMLAL, FMLAL2 (by element)
    0b00001111_10000000_00000000_00000000 = [Unimp] => [Unimp];
    // FMLAL, FMLAL2 (vector)
    0b00001110_00100000_11101100_00000000 = [Unimp] => [Unimp];
]
"fmlal2" = [
    // FMLAL, FMLAL2 (by element)
    0b00101111_10000000_10000000_00000000 = [Unimp] => [Unimp];
    // FMLAL, FMLAL2 (vector)
    0b00101110_00100000_11001100_00000000 = [Unimp] => [Unimp];
]
"fmls" = [
    // FMLS (by element)
    0b01011111_00000000_01010000_00000000 = [H, H, VLanes(WORD)] => [Unimp];
    0b01011111_10000000_01010000_00000000 = [V, V, Unimp] => [Unimp];
    0b00001111_00000000_01010000_00000000 = [Unimp] => [Unimp];
    0b00001111_10000000_01010000_00000000 = [Unimp] => [Unimp];
    // FMLS (vector)
    0b00001110_11000000_00001100_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11001100_00000000 = [Unimp] => [Unimp];
]
"fmlsl" = [
    // FMLSL, FMLSL2 (by element)
    0b00001111_10000000_01000000_00000000 = [Unimp] => [Unimp];
    // FMLSL, FMLSL2 (vector)
    0b00001110_10100000_11101100_00000000 = [Unimp] => [Unimp];
]
"fmlsl2" = [
    // FMLSL, FMLSL2 (by element)
    0b00101111_10000000_11000000_00000000 = [Unimp] => [Unimp];
    // FMLSL, FMLSL2 (vector)
    0b00101110_10100000_11001100_00000000 = [Unimp] => [Unimp];
]
"fmov" = [
    // FMOV (vector, immediate)
    0b00001111_00000000_11111100_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_11110100_00000000 = [Unimp] => [Unimp];
    0b01101111_00000000_11110100_00000000 = [VSizedStatic(QWORD, 2), Imm] => [Unimp];
    // FMOV (register)
...
"fmul" = [
    // FMUL (by element)
    0b01011111_00000000_10010000_00000000 = [H, H, VLanes(WORD)] => [Unimp];
    0b01011111_10000000_10010000_00000000 = [V, V, Unimp] => [Unimp];
    0b00001111_00000000_10010000_00000000 = [Unimp] => [Unimp];
    0b00001111_10000000_10010000_00000000 = [Unimp] => [Unimp];
    // FMUL (vector)
    0b00101110_01000000_00011100_00000000 = [Unimp] => [Unimp];
    0b00101110_00100000_11011100_00000000 = [Unimp] => [Unimp];
    // FMUL (scalar)
...
"fmulx" = [
    // FMULX (by element)
    0b01111111_00000000_10010000_00000000 = [H, H, VLanes(WORD)] => [Unimp];
    0b01111111_10000000_10010000_00000000 = [V, V, Unimp] => [Unimp];
    0b00101111_00000000_10010000_00000000 = [Unimp] => [Unimp];
    0b00101111_10000000_10010000_00000000 = [Unimp] => [Unimp];
    // FMULX
    0b01011110_01000000_00011100_00000000 = [H, H, H] => [R(0), R(5), R(16)];
    0b01011110_00100000_11011100_00000000 = [V, V, V] => [Unimp];
    0b00001110_01000000_00011100_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_11011100_00000000 = [Unimp] => [Unimp];
]
"fneg" = [
    // FNEG (vector)
    0b00101110_11111000_11111000_00000000 = [Unimp] => [Unimp];
    0b00101110_10100000_11111000_00000000 = [Unimp] => [Unimp];
    // FNEG (scalar)
...
"frecpe" = [
    ...
    0b01011110_10100001_11011000_00000000 = [V, V] => [Unimp];
    0b00001110_11111001_11011000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100001_11011000_00000000 = [Unimp] => [Unimp];
]
"frecps" = [
    0b01011110_01000000_00111100_00000000 = [H, H, H] => [R(0), R(5), R(16)];
    0b01011110_00100000_11111100_00000000 = [V, V, V] => [Unimp];
    0b00001110_01000000_00111100_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_11111100_00000000 = [Unimp] => [Unimp];
]
"frecpx" = [
    0b01011110_11111001_11111000_00000000 = [H, H] => [R(0), R(5)];
    0b01011110_10100001_11111000_00000000 = [V, V] => [Unimp];
]
"frinta" = [
    // FRINTA (vector)
    0b00101110_01111001_10001000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_10001000_00000000 = [Unimp] => [Unimp];
    // FRINTA (scalar)
...
"frinti" = [
    // FRINTI (vector)
    0b00101110_11111001_10011000_00000000 = [Unimp] => [Unimp];
    0b00101110_10100001_10011000_00000000 = [Unimp] => [Unimp];
    // FRINTI (scalar)
...
"frintm" = [
    // FRINTM (vector)
    0b00001110_01111001_10011000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100001_10011000_00000000 = [Unimp] => [Unimp];
    // FRINTM (scalar)
...
"frintn" = [
    // FRINTN (vector)
    0b00001110_01111001_10001000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100001_10001000_00000000 = [Unimp] => [Unimp];
    // FRINTN (scalar)
...
"frintp" = [
    // FRINTP (vector)
    0b00001110_11111001_10001000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100001_10001000_00000000 = [Unimp] => [Unimp];
    // FRINTP (scalar)
...
"frintx" = [
    // FRINTX (vector)
    0b00101110_01111001_10011000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_10011000_00000000 = [Unimp] => [Unimp];
    // FRINTX (scalar)
...
"frintz" = [
    // FRINTZ (vector)
    0b00001110_11111001_10011000_00000000 = [Unimp] => [Unimp];
    0b00001110_10100001_10011000_00000000 = [Unimp] => [Unimp];
    // FRINTZ (scalar)
...
"frsqrte" = [
    ...
    0b01111110_10100001_11011000_00000000 = [V, V] => [Unimp];
    0b00101110_11111001_11011000_00000000 = [Unimp] => [Unimp];
    0b00101110_10100001_11011000_00000000 = [Unimp] => [Unimp];
]
"frsqrts" = [
    0b01011110_11000000_00111100_00000000 = [H, H, H] => [R(0), R(5), R(16)];
    0b01011110_10100000_11111100_00000000 = [V, V, V] => [Unimp];
    0b00001110_11000000_00111100_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11111100_00000000 = [Unimp] => [Unimp];
]
"fsqrt" = [
    // FSQRT (vector)
    0b00101110_11111001_11111000_00000000 = [Unimp] => [Unimp];
    0b00101110_10100001_11111000_00000000 = [Unimp] => [Unimp];
    // FSQRT (scalar)
...
"fsub" = [
    // FSUB (vector)
    0b00001110_11000000_00010100_00000000 = [Unimp] => [Unimp];
    0b00001110_10100000_11010100_00000000 = [Unimp] => [Unimp];
    // FSUB (scalar)
...
"ins" = [
    // INS (element)
    0b01101110_00000000_00000100_00000000 = [Unimp] => [Unimp];
    // INS (general)
    0b01001110_00000000_00011100_00000000 = [Unimp] => [Unimp];
]
"isb" = [
    0b11010101_00000011_00110000_11011111 = [Lit("SY")] => [Static(8, 15)];
    0b11010101_00000011_00110000_11011111 = [Imm] => [Ubits(8, 4)];
    0b11010101_00000011_00110000_11011111 = [] => [Static(8, 15)];
]
"ld1" = [
    // LD1 (multiple structures)
    0b00001100_01000000_01110000_00000000 = [RegList(1), RefBase] => [Unimp];
    0b00001100_01000000_10100000_00000000 = [RegList(2), RefBase] => [Unimp];
    0b00001100_01000000_01100000_00000000 = [RegList(3), RefBase] => [Unimp];
    0b00001100_01000000_00100000_00000000 = [RegList(4), RefBase] => [Unimp];
    0b00001100_11011111_01110000_00000000 = [RegList(1), RefBase, Imm] => [Unimp];
    0b00001100_11000000_01110000_00000000 = [RegList(1), RefBase, X] => [Unimp];
    0b00001100_11011111_10100000_00000000 = [RegList(2), RefBase, Imm] => [Unimp];
    0b00001100_11000000_10100000_00000000 = [RegList(2), RefBase, X] => [Unimp];
    0b00001100_11011111_01100000_00000000 = [RegList(3), RefBase, Imm] => [Unimp];
    0b00001100_11000000_01100000_00000000 = [RegList(3), RefBase, X] => [Unimp];
    0b00001100_11011111_00100000_00000000 = [RegList(4), RefBase, Imm] => [Unimp];
    0b00001100_11000000_00100000_00000000 = [RegList(4), RefBase, X] => [Unimp];
...
"ld1r" = [
    0b00001101_01000000_11000000_00000000 = [RegList(1), RefBase] => [Unimp];
    0b00001101_11011111_11000000_00000000 = [RegList(1), RefBase, Imm] => [Unimp];
    0b00001101_11000000_11000000_00000000 = [RegList(1), RefBase, X] => [Unimp];
]
"ld2" = [
    // LD2 (multiple structures)
    0b00001100_01000000_10000000_00000000 = [RegList(2), RefBase] => [Unimp];
    0b00001100_11011111_10000000_00000000 = [RegList(2), RefBase, Imm] => [Unimp];
    0b00001100_11000000_10000000_00000000 = [RegList(2), RefBase, X] => [Unimp];
...
"ld2r" = [
    0b00001101_01100000_11000000_00000000 = [RegList(2), RefBase] => [Unimp];
    0b00001101_11111111_11000000_00000000 = [RegList(2), RefBase, Imm] => [Unimp];
    0b00001101_11100000_11000000_00000000 = [RegList(2), RefBase, X] => [Unimp];
]
"ld3" = [
    // LD3 (multiple structures)
    0b00001100_01000000_01000000_00000000 = [RegList(3), RefBase] => [Unimp];
    0b00001100_11011111_01000000_00000000 = [RegList(3), RefBase, Imm] => [Unimp];
    0b00001100_11000000_01000000_00000000 = [RegList(3), RefBase, X] => [Unimp];
...
"ld3r" = [
    0b00001101_01000000_11100000_00000000 = [RegList(3), RefBase] => [Unimp];
    0b00001101_11011111_11100000_00000000 = [RegList(3), RefBase, Imm] => [Unimp];
    0b00001101_11000000_11100000_00000000 = [RegList(3), RefBase, X] => [Unimp];
]
"ld4" = [
    // LD4 (multiple structures)
    0b00001100_01000000_00000000_00000000 = [RegList(4), RefBase] => [Unimp];
    0b00001100_11011111_00000000_00000000 = [RegList(4), RefBase, Imm] => [Unimp];
    0b00001100_11000000_00000000_00000000 = [RegList(4), RefBase, X] => [Unimp];
...
"ld4r" = [
    0b00001101_01100000_11100000_00000000 = [RegList(4), RefBase] => [Unimp];
    0b00001101_11111111_11100000_00000000 = [RegList(4), RefBase, Imm] => [Unimp];
    0b00001101_11100000_11100000_00000000 = [RegList(4), RefBase, X] => [Unimp];
]
"ldadd" = [
...
"mla" = [
    // MLA (by element)
    0b00101111_00000000_00000000_00000000 = [Unimp] => [Unimp];
    // MLA (vector)
    0b00001110_00100000_10010100_00000000 = [Unimp] => [Unimp];
]
"mls" = [
    // MLS (by element)
    0b00101111_00000000_01000000_00000000 = [Unimp] => [Unimp];
    // MLS (vector)
    0b00101110_00100000_10010100_00000000 = [Unimp] => [Unimp];
]
"mneg" = [
...
"mov" = [
    ...
    0b00010010_10000000_00000000_00000000 = [Dot, Lit("inverted"), W, Imm] => [R(0), Unimp];
    0b10010010_10000000_00000000_00000000 = [Dot, Lit("inverted"), X, Imm] => [R(0), Unimp];
    // MOV (wide immediate)
    0b01010010_10000000_00000000_00000000 = [W, Imm] => [R(0), Unimp];
    0b11010010_10000000_00000000_00000000 = [X, Imm] => [R(0), Unimp];
    // MOV (vector)
    0b00001110_10100000_00011100_00000000 = [Unimp] => [Unimp];
    ...
    // MOV (to general)
    0b00001110_00000100_00111100_00000000 = [Unimp] => [Unimp];
    0b01001110_00001000_00111100_00000000 = [Unimp] => [Unimp];
]
"movi" = [
    0b00001111_00000000_11100100_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_10000100_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_00000100_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_11000100_00000000 = [Unimp] => [Unimp];
    0b00101111_00000000_11100100_00000000 = [D, Imm] => [R(0), BUbits(8), BUslice(5, 5, 0), BUslice(16, 3, 5)];
    0b01101111_00000000_11100100_00000000 = [VSizedStatic(QWORD, 2), Imm] => [Unimp];
]
"movk" = [
...
"mul" = [
    // MUL (by element)
    0b00001111_00000000_10000000_00000000 = [Unimp] => [Unimp];
    // MUL (vector)
    0b00001110_00100000_10011100_00000000 = [Unimp] => [Unimp];
    // MUL
...
"mvn" = [
    ...
    0b00101110_00100000_01011000_00000000 = [Unimp] => [Unimp];
]
"mvni" = [
    0b00101111_00000000_10000100_00000000 = [Unimp] => [Unimp];
    0b00101111_00000000_00000100_00000000 = [Unimp] => [Unimp];
    0b00101111_00000000_11000100_00000000 = [Unimp] => [Unimp];
]
"neg" = [
    ...
    // NEG (vector)
    0b01111110_00100000_10111000_00000000 = [V, V] => [Unimp];
    0b00101110_00100000_10111000_00000000 = [Unimp] => [Unimp];
]
"negs" = [
...
"orn" = [
    // ORN (vector)
    0b00001110_11100000_00011100_00000000 = [Unimp] => [Unimp];
...
"orr" = [
    ...
    0b00001111_00000000_10010100_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_00010100_00000000 = [Unimp] => [Unimp];
    // ORR (vector, register)
    0b00001110_10100000_00011100_00000000 = [Unimp] => [Unimp];
    // ORR (immediate)
...
"pmul" = [
    0b00101110_00100000_10011100_00000000 = [Unimp] => [Unimp];
]
"pmull" = [
    0b00001110_00100000_11100000_00000000 = [Unimp] => [Unimp];
]
"pmull2" = [
    0b01001110_00100000_11100000_00000000 = [Unimp] => [Unimp];
]
"prfm" = [
    // PRFM (literal)
...
"raddhn" = [
    0b00101110_00100000_01000000_00000000 = [Unimp] => [Unimp];
]
"raddhn2" = [
    0b01101110_00100000_01000000_00000000 = [Unimp] => [Unimp];
]
"rax1" = [
    0b11001110_01100000_10001100_00000000 = [VSizedStatic(QWORD, 2), VSizedStatic(QWORD, 2), VSizedStatic(QWORD, 2)] => [Unimp];
]
"rbit" = [
    // RBIT (vector)
    0b00101110_01100000_01011000_00000000 = [Unimp] => [Unimp];
    // RBIT
...
"ret" = [
    ...
    0b11010110_01011111_00000000_00000000 = [] => [Static(5, 30)];
]
"retaa" = [
...
"rev16" = [
    // REV16 (vector)
    0b00001110_00100000_00011000_00000000 = [Unimp] => [Unimp];
    // REV16
...
"rev32" = [
    // REV32 (vector)
    0b00101110_00100000_00001000_00000000 = [Unimp] => [Unimp];
    // REV32
    0b11011010_11000000_00001000_00000000 = [X, X] => [R(0), R(5)];
]
"rev64" = [
    0b00001110_00100000_00001000_00000000 = [Unimp] => [Unimp];
    0b11011010_11000000_00001100_00000000 = [X, X] => [R(0), R(5)];
]
"rmif" = [
...
"rshrn" = [
    0b00001111_00000000_10001100_00000000 = [Unimp] => [Unimp];
]
"rshrn2" = [
    0b01001111_00000000_10001100_00000000 = [Unimp] => [Unimp];
]
"rsubhn" = [
    0b00101110_00100000_01100000_00000000 = [Unimp] => [Unimp];
]
"rsubhn2" = [
    0b01101110_00100000_01100000_00000000 = [Unimp] => [Unimp];
]
"saba" = [
    0b00001110_00100000_01111100_00000000 = [Unimp] => [Unimp];
]
"sabal" = [
    0b00001110_00100000_01010000_00000000 = [Unimp] => [Unimp];
]
"sabal2" = [
    0b01001110_00100000_01010000_00000000 = [Unimp] => [Unimp];
]
"sabd" = [
    0b00001110_00100000_01110100_00000000 = [Unimp] => [Unimp];
]
"sabdl" = [
    0b00001110_00100000_01110000_00000000 = [Unimp] => [Unimp];
]
"sabdl2" = [
    0b01001110_00100000_01110000_00000000 = [Unimp] => [Unimp];
]
"sadalp" = [
    0b00001110_00100000_01101000_00000000 = [Unimp] => [Unimp];
]
"saddl" = [
    0b00001110_00100000_00000000_00000000 = [Unimp] => [Unimp];
]
"saddl2" = [
    0b01001110_00100000_00000000_00000000 = [Unimp] => [Unimp];
]
"saddlp" = [
    0b00001110_00100000_00101000_00000000 = [Unimp] => [Unimp];
]
"saddlv" = [
    0b00001110_00110000_00111000_00000000 = [V, VWild] => [Unimp];
]
"saddw" = [
    0b00001110_00100000_00010000_00000000 = [Unimp] => [Unimp];
]
"saddw2" = [
    0b01001110_00100000_00010000_00000000 = [Unimp] => [Unimp];
]
"sb" = [
...
"scvtf" = [
    ...
    0b01011111_00000000_11100100_00000000 = [V, V, Imm] => [Unimp];
    0b00001111_00000000_11100100_00000000 = [Unimp] => [Unimp];
    // SCVTF (vector, integer)
    0b01011110_01111001_11011000_00000000 = [H, H] => [R(0), R(5)];
    0b01011110_00100001_11011000_00000000 = [V, V] => [Unimp];
    0b00001110_01111001_11011000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100001_11011000_00000000 = [Unimp] => [Unimp];
...
"sdot" = [
    // SDOT (by element)
    0b00001111_00000000_11100000_00000000 = [Unimp] => [Unimp];
    // SDOT (vector)
    0b00001110_00000000_10010100_00000000 = [Unimp] => [Unimp];
]
"setf16" = [
...
"sha1c" = [
    0b01011110_00000000_00000000_00000000 = [Q, S, VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha1h" = [
    0b01011110_00101000_00001000_00000000 = [S, S] => [R(0), R(5)];
]
"sha1m" = [
    0b01011110_00000000_00100000_00000000 = [Q, S, VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha1p" = [
    0b01011110_00000000_00010000_00000000 = [Q, S, VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha1su0" = [
    0b01011110_00000000_00110000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha1su1" = [
    0b01011110_00101000_00011000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha256h" = [
    0b01011110_00000000_01000000_00000000 = [Q, Q, VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha256h2" = [
    0b01011110_00000000_01010000_00000000 = [Q, Q, VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha256su0" = [
    0b01011110_00101000_00101000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha256su1" = [
    0b01011110_00000000_01100000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"sha512h" = [
    0b11001110_01100000_10000000_00000000 = [Q, Q, VSizedStatic(QWORD, 2)] => [Unimp];
]
"sha512h2" = [
    0b11001110_01100000_10000100_00000000 = [Q, Q, VSizedStatic(QWORD, 2)] => [Unimp];
]
"sha512su0" = [
    0b11001110_11000000_10000000_00000000 = [VSizedStatic(QWORD, 2), VSizedStatic(QWORD, 2)] => [Unimp];
]
"sha512su1" = [
    0b11001110_01100000_10001000_00000000 = [VSizedStatic(QWORD, 2), VSizedStatic(QWORD, 2), VSizedStatic(QWORD, 2)] => [Unimp];
]
"shadd" = [
    0b00001110_00100000_00000100_00000000 = [Unimp] => [Unimp];
]
"shl" = [
    0b01011111_00000000_01010100_00000000 = [V, V, Imm] => [Unimp];
    0b00001111_00000000_01010100_00000000 = [Unimp] => [Unimp];
]
"shll" = [
    0b00101110_00100001_00111000_00000000 = [Unimp] => [Unimp];
]
"shll2" = [
    0b01101110_00100001_00111000_00000000 = [Unimp] => [Unimp];
]
"shrn" = [
    0b00001111_00000000_10000100_00000000 = [Unimp] => [Unimp];
]
"shrn2" = [
    0b01001111_00000000_10000100_00000000 = [Unimp] => [Unimp];
]
"shsub" = [
    0b00001110_00100000_00100100_00000000 = [Unimp] => [Unimp];
]
"sli" = [
    0b01111111_00000000_01010100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_01010100_00000000 = [Unimp] => [Unimp];
]
"sm3partw1" = [
    0b11001110_01100000_11000000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"sm3partw2" = [
    0b11001110_01100000_11000100_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"sm3ss1" = [
    0b11001110_01000000_00000000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"sm3tt1a" = [
    0b11001110_01000000_10000000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VLanes(DWORD)] => [Unimp];
]
"sm3tt1b" = [
    0b11001110_01000000_10000100_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VLanes(DWORD)] => [Unimp];
]
"sm3tt2a" = [
    0b11001110_01000000_10001000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VLanes(DWORD)] => [Unimp];
]
"sm3tt2b" = [
    0b11001110_01000000_10001100_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VLanes(DWORD)] => [Unimp];
]
"sm4e" = [
    0b11001110_11000000_10000100_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"sm4ekey" = [
    0b11001110_01100000_11001000_00000000 = [VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4), VSizedStatic(DWORD, 4)] => [Unimp];
]
"smaddl" = [
    0b10011011_00100000_00000000_00000000 = [X, W, W, X] => [R(0), R(5), R(16), R(10)];
]
"smax" = [
    0b00001110_00100000_01100100_00000000 = [Unimp] => [Unimp];
]
"smaxp" = [
    0b00001110_00100000_10100100_00000000 = [Unimp] => [Unimp];
]
"smaxv" = [
    0b00001110_00110000_10101000_00000000 = [V, VWild] => [Unimp];
]
"smc" = [
    0b11010100_00000000_00000000_00000011 = [Imm] => [Ubits(5, 16)];
]
"smin" = [
    0b00001110_00100000_01101100_00000000 = [Unimp] => [Unimp];
]
"sminp" = [
    0b00001110_00100000_10101100_00000000 = [Unimp] => [Unimp];
]
"sminv" = [
    0b00001110_00110001_10101000_00000000 = [V, VWild] => [Unimp];
]
"smlal" = [
    // SMLAL, SMLAL2 (by element)
    0b00001111_00000000_00100000_00000000 = [Unimp] => [Unimp];
    // SMLAL, SMLAL2 (vector)
    0b00001110_00100000_10000000_00000000 = [Unimp] => [Unimp];
]
"smlal2" = [
    // SMLAL, SMLAL2 (by element)
    0b01001111_00000000_00100000_00000000 = [Unimp] => [Unimp];
    // SMLAL, SMLAL2 (vector)
    0b01001110_00100000_10000000_00000000 = [Unimp] => [Unimp];
]
"smlsl" = [
    // SMLSL, SMLSL2 (by element)
    0b00001111_00000000_01100000_00000000 = [Unimp] => [Unimp];
    // SMLSL, SMLSL2 (vector)
    0b00001110_00100000_10100000_00000000 = [Unimp] => [Unimp];
]
"smlsl2" = [
    // SMLSL, SMLSL2 (by element)
    0b01001111_00000000_01100000_00000000 = [Unimp] => [Unimp];
    // SMLSL, SMLSL2 (vector)
    0b01001110_00100000_10100000_00000000 = [Unimp] => [Unimp];
]
"smnegl" = [
    0b10011011_00100000_11111100_00000000 = [X, W, W] => [R(0), R(5), R(16)];
]
"smov" = [
    0b00001110_00000000_00101100_00000000 = [Unimp] => [Unimp];
    0b01001110_00000000_00101100_00000000 = [Unimp] => [Unimp];
]
"smsubl" = [
...
"smull" = [
    ...
    0b00001111_00000000_10100000_00000000 = [Unimp] => [Unimp];
    // SMULL, SMULL2 (vector)
    0b00001110_00100000_11000000_00000000 = [Unimp] => [Unimp];
    // SMULL
    0b10011011_00100000_01111100_00000000 = [X, W, W] => [R(0), R(5), R(16)];
]
"smull2" = [
    // SMULL, SMULL2 (by element)
    0b01001111_00000000_10100000_00000000 = [Unimp] => [Unimp];
    // SMULL, SMULL2 (vector)
    0b01001110_00100000_11000000_00000000 = [Unimp] => [Unimp];
]
"sqabs" = [
    0b01011110_00100000_01111000_00000000 = [V, V] => [Unimp];
    0b00001110_00100000_01111000_00000000 = [Unimp] => [Unimp];
]
"sqadd" = [
    0b01011110_00100000_00001100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_00001100_00000000 = [Unimp] => [Unimp];
]
"sqdmlal" = [
    // SQDMLAL, SQDMLAL2 (by element)
    0b01011111_00000000_00110000_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_00110000_00000000 = [Unimp] => [Unimp];
    // SQDMLAL, SQDMLAL2 (vector)
    0b01011110_00100000_10010000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_10010000_00000000 = [Unimp] => [Unimp];
]
"sqdmlal2" = [
    // SQDMLAL, SQDMLAL2 (by element)
    0b01001111_00000000_00110000_00000000 = [Unimp] => [Unimp];
    // SQDMLAL, SQDMLAL2 (vector)
    0b01001110_00100000_10010000_00000000 = [Unimp] => [Unimp];
]
"sqdmlsl" = [
    // SQDMLSL, SQDMLSL2 (by element)
    0b01011111_00000000_01110000_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_01110000_00000000 = [Unimp] => [Unimp];
    // SQDMLSL, SQDMLSL2 (vector)
    0b01011110_00100000_10110000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_10110000_00000000 = [Unimp] => [Unimp];
]
"sqdmlsl2" = [
    // SQDMLSL, SQDMLSL2 (by element)
    0b01001111_00000000_01110000_00000000 = [Unimp] => [Unimp];
    // SQDMLSL, SQDMLSL2 (vector)
    0b01001110_00100000_10110000_00000000 = [Unimp] => [Unimp];
]
"sqdmulh" = [
    // SQDMULH (by element)
    0b01011111_00000000_11000000_00000000 = [V, V, Unimp] => [Unimp];
    0b00001111_00000000_11000000_00000000 = [Unimp] => [Unimp];
    // SQDMULH (vector)
    0b01011110_00100000_10110100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_10110100_00000000 = [Unimp] => [Unimp];
]
"sqdmull" = [
    // SQDMULL, SQDMULL2 (by element)
    0b01011111_00000000_10110000_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_10110000_00000000 = [Unimp] => [Unimp];
    // SQDMULL, SQDMULL2 (vector)
    0b01011110_00100000_11010000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100000_11010000_00000000 = [Unimp] => [Unimp];
]
"sqdmull2" = [
    // SQDMULL, SQDMULL2 (by element)
    0b01001111_00000000_10110000_00000000 = [Unimp] => [Unimp];
    // SQDMULL, SQDMULL2 (vector)
    0b01001110_00100000_11010000_00000000 = [Unimp] => [Unimp];
]
"sqneg" = [
    0b01111110_00100000_01111000_00000000 = [V, V] => [Unimp];
    0b00101110_00100000_01111000_00000000 = [Unimp] => [Unimp];
]
"sqrdmlah" = [
    // SQRDMLAH (by element)
    0b01111111_00000000_11010000_00000000 = [V, V, Unimp] => [Unimp];
    0b00101111_00000000_11010000_00000000 = [Unimp] => [Unimp];
    // SQRDMLAH (vector)
    0b01111110_00000000_10000100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00000000_10000100_00000000 = [Unimp] => [Unimp];
]
"sqrdmlsh" = [
    // SQRDMLSH (by element)
    0b01111111_00000000_11110000_00000000 = [V, V, Unimp] => [Unimp];
    0b00101111_00000000_11110000_00000000 = [Unimp] => [Unimp];
    // SQRDMLSH (vector)
    0b01111110_00000000_10001100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00000000_10001100_00000000 = [Unimp] => [Unimp];
]
"sqrdmulh" = [
    // SQRDMULH (by element)
    0b01011111_00000000_11010000_00000000 = [V, V, Unimp] => [Unimp];
    0b00001111_00000000_11010000_00000000 = [Unimp] => [Unimp];
    // SQRDMULH (vector)
    0b01111110_00100000_10110100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_10110100_00000000 = [Unimp] => [Unimp];
]
"sqrshl" = [
    0b01011110_00100000_01011100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_01011100_00000000 = [Unimp] => [Unimp];
]
"sqrshrn" = [
    0b01011111_00000000_10011100_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_10011100_00000000 = [Unimp] => [Unimp];
]
"sqrshrn2" = [
    0b01001111_00000000_10011100_00000000 = [Unimp] => [Unimp];
]
"sqrshrun" = [
    0b01111111_00000000_10001100_00000000 = [Unimp] => [Unimp];
    0b00101111_00000000_10001100_00000000 = [Unimp] => [Unimp];
]
"sqrshrun2" = [
    0b01101111_00000000_10001100_00000000 = [Unimp] => [Unimp];
]
"sqshl" = [
    // SQSHL (immediate)
    0b01011111_00000000_01110100_00000000 = [V, V, Imm] => [Unimp];
    0b00001111_00000000_01110100_00000000 = [Unimp] => [Unimp];
    // SQSHL (register)
    0b01011110_00100000_01001100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_01001100_00000000 = [Unimp] => [Unimp];
]
"sqshlu" = [
    0b01111111_00000000_01100100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_01100100_00000000 = [Unimp] => [Unimp];
]
"sqshrn" = [
    0b01011111_00000000_10010100_00000000 = [Unimp] => [Unimp];
    0b00001111_00000000_10010100_00000000 = [Unimp] => [Unimp];
]
"sqshrn2" = [
    0b01001111_00000000_10010100_00000000 = [Unimp] => [Unimp];
]
"sqshrun" = [
    0b01111111_00000000_10000100_00000000 = [Unimp] => [Unimp];
    0b00101111_00000000_10000100_00000000 = [Unimp] => [Unimp];
]
"sqshrun2" = [
    0b01101111_00000000_10000100_00000000 = [Unimp] => [Unimp];
]
"sqsub" = [
    0b01011110_00100000_00101100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_00101100_00000000 = [Unimp] => [Unimp];
]
"sqxtn" = [
    0b01011110_00100001_01001000_00000000 = [Unimp] => [Unimp];
    0b00001110_00100001_01001000_00000000 = [Unimp] => [Unimp];
]
"sqxtn2" = [
    0b01001110_00100001_01001000_00000000 = [Unimp] => [Unimp];
]
"sqxtun" = [
    0b01111110_00100001_00101000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_00101000_00000000 = [Unimp] => [Unimp];
]
"sqxtun2" = [
    0b01101110_00100001_00101000_00000000 = [Unimp] => [Unimp];
]
"srhadd" = [
    0b00001110_00100000_00010100_00000000 = [Unimp] => [Unimp];
]
"sri" = [
    0b01111111_00000000_01000100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_01000100_00000000 = [Unimp] => [Unimp];
]
"srshl" = [
    0b01011110_00100000_01010100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_01010100_00000000 = [Unimp] => [Unimp];
]
"srshr" = [
    0b01011111_00000000_00100100_00000000 = [V, V, Imm] => [Unimp];
    0b00001111_00000000_00100100_00000000 = [Unimp] => [Unimp];
]
"srsra" = [
    0b01011111_00000000_00110100_00000000 = [V, V, Imm] => [Unimp];
    0b00001111_00000000_00110100_00000000 = [Unimp] => [Unimp];
]
"ssbb" = [
    0b11010101_00000011_00110000_10011111 = [] => [];
]
"sshl" = [
    0b01011110_00100000_01000100_00000000 = [V, V, V] => [Unimp];
    0b00001110_00100000_01000100_00000000 = [Unimp] => [Unimp];
]
"sshll" = [
    0b00001111_00000000_10100100_00000000 = [Unimp] => [Unimp];
]
"sshll2" = [
    0b01001111_00000000_10100100_00000000 = [Unimp] => [Unimp];
]
"sshr" = [
    0b01011111_00000000_00000100_00000000 = [V, V, Imm] => [Unimp];
    0b00001111_00000000_00000100_00000000 = [Unimp] => [Unimp];
]
"ssra" = [
    0b01011111_00000000_00010100_00000000 = [V, V, Imm] => [Unimp];
    0b00001111_00000000_00010100_00000000 = [Unimp] => [Unimp];
]
"ssubl" = [
    0b00001110_00100000_00100000_00000000 = [Unimp] => [Unimp];
]
"ssubl2" = [
    0b01001110_00100000_00100000_00000000 = [Unimp] => [Unimp];
]
"ssubw" = [
    0b00001110_00100000_00110000_00000000 = [Unimp] => [Unimp];
]
"ssubw2" = [
    0b01001110_00100000_00110000_00000000 = [Unimp] => [Unimp];
]
"st1" = [
    // ST1 (multiple structures)
    0b00001100_00000000_01110000_00000000 = [RegList(1), RefBase] => [Unimp];
    0b00001100_00000000_10100000_00000000 = [RegList(2), RefBase] => [Unimp];
    0b00001100_00000000_01100000_00000000 = [RegList(3), RefBase] => [Unimp];
    0b00001100_00000000_00100000_00000000 = [RegList(4), RefBase] => [Unimp];
    0b00001100_10011111_01110000_00000000 = [RegList(1), RefBase, Imm] => [Unimp];
    0b00001100_10000000_01110000_00000000 = [RegList(1), RefBase, X] => [Unimp];
    0b00001100_10011111_10100000_00000000 = [RegList(2), RefBase, Imm] => [Unimp];
    0b00001100_10000000_10100000_00000000 = [RegList(2), RefBase, X] => [Unimp];
    0b00001100_10011111_01100000_00000000 = [RegList(3), RefBase, Imm] => [Unimp];
    0b00001100_10000000_01100000_00000000 = [RegList(3), RefBase, X] => [Unimp];
    0b00001100_10011111_00100000_00000000 = [RegList(4), RefBase, Imm] => [Unimp];
    0b00001100_10000000_00100000_00000000 = [RegList(4), RefBase, X] => [Unimp];
...
"st2" = [
    ...
    0b00001100_00000000_10000000_00000000 = [RegList(2), RefBase] => [Unimp];
    0b00001100_10011111_10000000_00000000 = [RegList(2), RefBase, Imm] => [Unimp];
    0b00001100_10000000_10000000_00000000 = [RegList(2), RefBase, X] => [Unimp];
...
"st3" = [
    ...
    0b00001100_00000000_01000000_00000000 = [RegList(3), RefBase] => [Unimp];
    0b00001100_10011111_01000000_00000000 = [RegList(3), RefBase, Imm] => [Unimp];
    0b00001100_10000000_01000000_00000000 = [RegList(3), RefBase, X] => [Unimp];
...
"st4" = [
    ...
    0b00001100_00000000_00000000_00000000 = [RegList(4), RefBase] => [Unimp];
    0b00001100_10011111_00000000_00000000 = [RegList(4), RefBase, Imm] => [Unimp];
    0b00001100_10000000_00000000_00000000 = [RegList(4), RefBase, X] => [Unimp];
...
"sub" = [
    ...
    // SUB (vector)
    0b01111110_00100000_10000100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_10000100_00000000 = [Unimp] => [Unimp];
]
"subhn" = [
    0b00001110_00100000_01100000_00000000 = [Unimp] => [Unimp];
]
"subhn2" = [
    0b01001110_00100000_01100000_00000000 = [Unimp] => [Unimp];
]
"subs" = [
...
"suqadd" = [
    0b01011110_00100000_00111000_00000000 = [V, V] => [Unimp];
    0b00001110_00100000_00111000_00000000 = [Unimp] => [Unimp];
]
"svc" = [
...
"tbl" = [
    0b00001110_00000000_00100000_00000000 = [Unimp] => [Unimp];
    0b00001110_00000000_01000000_00000000 = [Unimp] => [Unimp];
    0b00001110_00000000_01100000_00000000 = [Unimp] => [Unimp];
    0b00001110_00000000_00000000_00000000 = [Unimp] => [Unimp];
]
"tbnz" = [
...
"tbx" = [
    0b00001110_00000000_00110000_00000000 = [Unimp] => [Unimp];
    0b00001110_00000000_01010000_00000000 = [Unimp] => [Unimp];
    0b00001110_00000000_01110000_00000000 = [Unimp] => [Unimp];
    0b00001110_00000000_00010000_00000000 = [Unimp] => [Unimp];
]
"tbz" = [
...
"trn1" = [
    0b00001110_00000000_00101000_00000000 = [Unimp] => [Unimp];
]
"trn2" = [
    0b00001110_00000000_01101000_00000000 = [Unimp] => [Unimp];
]
"tsb" = [
...
"uaba" = [
    0b00101110_00100000_01111100_00000000 = [Unimp] => [Unimp];
]
"uabal" = [
    0b00101110_00100000_01010000_00000000 = [Unimp] => [Unimp];
]
"uabal2" = [
    0b01101110_00100000_01010000_00000000 = [Unimp] => [Unimp];
]
"uabd" = [
    0b00101110_00100000_01110100_00000000 = [Unimp] => [Unimp];
]
"uabdl" = [
    0b00101110_00100000_01110000_00000000 = [Unimp] => [Unimp];
]
"uabdl2" = [
    0b01101110_00100000_01110000_00000000 = [Unimp] => [Unimp];
]
"uadalp" = [
    0b00101110_00100000_01101000_00000000 = [Unimp] => [Unimp];
]
"uaddl" = [
    0b00101110_00100000_00000000_00000000 = [Unimp] => [Unimp];
]
"uaddl2" = [
    0b01101110_00100000_00000000_00000000 = [Unimp] => [Unimp];
]
"uaddlp" = [
    0b00101110_00100000_00101000_00000000 = [Unimp] => [Unimp];
]
"uaddlv" = [
    0b00101110_00110000_00111000_00000000 = [V, VWild] => [Unimp];
]
"uaddw" = [
    0b00101110_00100000_00010000_00000000 = [Unimp] => [Unimp];
]
"uaddw2" = [
    0b01101110_00100000_00010000_00000000 = [Unimp] => [Unimp];
]
"ubfiz" = [
...
"ucvtf" = [
    ...
    0b01111111_00000000_11100100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_11100100_00000000 = [Unimp] => [Unimp];
    // UCVTF (vector, integer)
    0b01111110_01111001_11011000_00000000 = [H, H] => [R(0), R(5)];
    0b01111110_00100001_11011000_00000000 = [V, V] => [Unimp];
    0b00101110_01111001_11011000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_11011000_00000000 = [Unimp] => [Unimp];
...
"udot" = [
    // UDOT (by element)
    0b00101111_00000000_11100000_00000000 = [Unimp] => [Unimp];
    // UDOT (vector)
    0b00101110_00000000_10010100_00000000 = [Unimp] => [Unimp];
]
"uhadd" = [
    0b00101110_00100000_00000100_00000000 = [Unimp] => [Unimp];
]
"uhsub" = [
    0b00101110_00100000_00100100_00000000 = [Unimp] => [Unimp];
]
"umaddl" = [
    0b10011011_10100000_00000000_00000000 = [X, W, W, X] => [R(0), R(5), R(16), R(10)];
]
"umax" = [
    0b00101110_00100000_01100100_00000000 = [Unimp] => [Unimp];
]
"umaxp" = [
    0b00101110_00100000_10100100_00000000 = [Unimp] => [Unimp];
]
"umaxv" = [
    0b00101110_00110000_10101000_00000000 = [V, VWild] => [Unimp];
]
"umin" = [
    0b00101110_00100000_01101100_00000000 = [Unimp] => [Unimp];
]
"uminp" = [
    0b00101110_00100000_10101100_00000000 = [Unimp] => [Unimp];
]
"uminv" = [
    0b00101110_00110001_10101000_00000000 = [V, VWild] => [Unimp];
]
"umlal" = [
    // UMLAL, UMLAL2 (by element)
    0b00101111_00000000_00100000_00000000 = [Unimp] => [Unimp];
    // UMLAL, UMLAL2 (vector)
    0b00101110_00100000_10000000_00000000 = [Unimp] => [Unimp];
]
"umlal2" = [
    // UMLAL, UMLAL2 (by element)
    0b01101111_00000000_00100000_00000000 = [Unimp] => [Unimp];
    // UMLAL, UMLAL2 (vector)
    0b01101110_00100000_10000000_00000000 = [Unimp] => [Unimp];
]
"umlsl" = [
    // UMLSL, UMLSL2 (by element)
    0b00101111_00000000_01100000_00000000 = [Unimp] => [Unimp];
    // UMLSL, UMLSL2 (vector)
    0b00101110_00100000_10100000_00000000 = [Unimp] => [Unimp];
]
"umlsl2" = [
    // UMLSL, UMLSL2 (by element)
    0b01101111_00000000_01100000_00000000 = [Unimp] => [Unimp];
    // UMLSL, UMLSL2 (vector)
    0b01101110_00100000_10100000_00000000 = [Unimp] => [Unimp];
]
"umnegl" = [
    0b10011011_10100000_11111100_00000000 = [X, W, W] => [R(0), R(5), R(16)];
]
"umov" = [
    0b00001110_00000000_00111100_00000000 = [Unimp] => [Unimp];
    0b01001110_00001000_00111100_00000000 = [Unimp] => [Unimp];
]
"umsubl" = [
...
"umull" = [
    ...
    0b00101111_00000000_10100000_00000000 = [Unimp] => [Unimp];
    // UMULL, UMULL2 (vector)
    0b00101110_00100000_11000000_00000000 = [Unimp] => [Unimp];
    // UMULL
    0b10011011_10100000_01111100_00000000 = [X, W, W] => [R(0), R(5), R(16)];
]
"umull2" = [
    // UMULL, UMULL2 (by element)
    0b01101111_00000000_10100000_00000000 = [Unimp] => [Unimp];
    // UMULL, UMULL2 (vector)
    0b01101110_00100000_11000000_00000000 = [Unimp] => [Unimp];
]
"uqadd" = [
    0b01111110_00100000_00001100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_00001100_00000000 = [Unimp] => [Unimp];
]
"uqrshl" = [
    0b01111110_00100000_01011100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_01011100_00000000 = [Unimp] => [Unimp];
]
"uqrshrn" = [
    0b01111111_00000000_10011100_00000000 = [Unimp] => [Unimp];
    0b00101111_00000000_10011100_00000000 = [Unimp] => [Unimp];
]
"uqrshrn2" = [
    0b01101111_00000000_10011100_00000000 = [Unimp] => [Unimp];
]
"uqshl" = [
    // UQSHL (immediate)
    0b01111111_00000000_01110100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_01110100_00000000 = [Unimp] => [Unimp];
    // UQSHL (register)
    0b01111110_00100000_01001100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_01001100_00000000 = [Unimp] => [Unimp];
]
"uqshrn" = [
    0b01111111_00000000_10010100_00000000 = [Unimp] => [Unimp];
    0b00101111_00000000_10010100_00000000 = [Unimp] => [Unimp];
]
"uqshrn2" = [
    0b01101111_00000000_10010100_00000000 = [Unimp] => [Unimp];
]
"uqsub" = [
    0b01111110_00100000_00101100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_00101100_00000000 = [Unimp] => [Unimp];
]
"uqxtn" = [
    0b01111110_00100001_01001000_00000000 = [Unimp] => [Unimp];
    0b00101110_00100001_01001000_00000000 = [Unimp] => [Unimp];
]
"uqxtn2" = [
    0b01101110_00100001_01001000_00000000 = [Unimp] => [Unimp];
]
"urecpe" = [
    0b00001110_10100001_11001000_00000000 = [Unimp] => [Unimp];
]
"urhadd" = [
    0b00101110_00100000_00010100_00000000 = [Unimp] => [Unimp];
]
"urshl" = [
    0b01111110_00100000_01010100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_01010100_00000000 = [Unimp] => [Unimp];
]
"urshr" = [
    0b01111111_00000000_00100100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_00100100_00000000 = [Unimp] => [Unimp];
]
"ursqrte" = [
    0b00101110_10100001_11001000_00000000 = [Unimp] => [Unimp];
]
"ursra" = [
    0b01111111_00000000_00110100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_00110100_00000000 = [Unimp] => [Unimp];
]
"ushl" = [
    0b01111110_00100000_01000100_00000000 = [V, V, V] => [Unimp];
    0b00101110_00100000_01000100_00000000 = [Unimp] => [Unimp];
]
"ushll" = [
    0b00101111_00000000_10100100_00000000 = [Unimp] => [Unimp];
]
"ushll2" = [
    0b01101111_00000000_10100100_00000000 = [Unimp] => [Unimp];
]
"ushr" = [
    0b01111111_00000000_00000100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_00000100_00000000 = [Unimp] => [Unimp];
]
"usqadd" = [
    0b01111110_00100000_00111000_00000000 = [V, V] => [Unimp];
    0b00101110_00100000_00111000_00000000 = [Unimp] => [Unimp];
]
"usra" = [
    0b01111111_00000000_00010100_00000000 = [V, V, Imm] => [Unimp];
    0b00101111_00000000_00010100_00000000 = [Unimp] => [Unimp];
]
"usubl" = [
    0b00101110_00100000_00100000_00000000 = [Unimp] => [Unimp];
]
"usubl2" = [
    0b01101110_00100000_00100000_00000000 = [Unimp] => [Unimp];
]
"usubw" = [
    0b00101110_00100000_00110000_00000000 = [Unimp] => [Unimp];
]
"usubw2" = [
    0b01101110_00100000_00110000_00000000 = [Unimp] => [Unimp];
]
"uxtb" = [
...
"uzp1" = [
    0b00001110_00000000_00011000_00000000 = [Unimp] => [Unimp];
]
"uzp2" = [
    0b00001110_00000000_01011000_00000000 = [Unimp] => [Unimp];
]
"wfe" = [
...
"xar" = [
    0b11001110_10000000_00000000_00000000 = [VSizedStatic(QWORD, 2), VSizedStatic(QWORD, 2), VSizedStatic(QWORD, 2), Imm] => [Unimp];
]
"xpacd" = [
...
"xtn" = [
    0b00001110_00100001_00101000_00000000 = [Unimp] => [Unimp];
]
"xtn2" = [
    0b01001110_00100001_00101000_00000000 = [Unimp] => [Unimp];
]
"yield" = [
    0b11010101_00000011_00100000_00111111 = [] => [];
]
"zip1" = [
    0b00001110_00000000_00111000_00000000 = [Unimp] => [Unimp];
]
"zip2" = [
    0b00001110_00000000_01111000_00000000 = [Unimp] => [Unimp];
]
