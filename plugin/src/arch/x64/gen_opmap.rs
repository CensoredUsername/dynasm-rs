...
"cmpltsd" = [
    b"yomq"       , [0x0F, 0xC2, 0x01  ], X, IMM_OP | PREF_F2 | SSE2;
    b"yoyo"       , [0x0F, 0xC2, 0x01  ], X, IMM_OP | PREF_F2 | SSE2;
]
"cmpltss" = [
...
"cmpnltsd" = [
    b"yomq"       , [0x0F, 0xC2, 0x05  ], X, PREF_F2 | IMM_OP | SSE2;
...
"fadd" = [
    ...
    b"fpXp"       , [0xDC, 0xC0        ], X, SHORT_ARG | FPU;
    b"md"         , [0xD8              ], 0, FPU | EXACT_SIZE;
    b"mq"         , [0xDC              ], 0, FPU | EXACT_SIZE;
]
"faddp" = [
    b""           , [0xDE, 0xC1        ], X, FPU;
...
"fcom" = [
    ...
    b"md"         , [0xD8              ], 2, FPU | EXACT_SIZE;
    b"mq"         , [0xDC              ], 2, FPU | EXACT_SIZE;
]
"fcomi" = [
    b""           , [0xDB, 0xF1        ], X, FPU;
...
"fcomp" = [
    ...
    b"md"         , [0xD8              ], 3, FPU | EXACT_SIZE;
    b"mq"         , [0xDC              ], 3, FPU | EXACT_SIZE;
]
"fcompp" = [
    b""           , [0xDE, 0xD9        ], X, FPU;
]
...
"fdiv" = [
    ...
    b"fpXp"       , [0xDC, 0xF8        ], X, SHORT_ARG | FPU;
    b"md"         , [0xD8              ], 6, FPU | EXACT_SIZE;
    b"mq"         , [0xDC              ], 6, FPU | EXACT_SIZE;
]
"fdivp" = [
    b""           , [0xDE, 0xF9        ], X, FPU;
...
"fdivr" = [
    ...
    b"fpXp"       , [0xDC, 0xF0        ], X, SHORT_ARG | FPU;
    b"md"         , [0xD8              ], 7, FPU | EXACT_SIZE;
    b"mq"         , [0xDC              ], 7, FPU | EXACT_SIZE;
]
"fdivrp" = [
    b""           , [0xDE, 0xF1        ], X, FPU;
...
"fiadd" = [
    b"md"         , [0xDA              ], 0, FPU | EXACT_SIZE;
    b"mw"         , [0xDE              ], 0, FPU;
]
"ficom" = [
    b"md"         , [0xDA              ], 2, FPU | EXACT_SIZE;
    b"mw"         , [0xDE              ], 2, FPU;
]
"ficomp" = [
    b"md"         , [0xDA              ], 3, FPU | EXACT_SIZE;
    b"mw"         , [0xDE              ], 3, FPU;
]
"fidiv" = [
    b"md"         , [0xDA              ], 6, FPU | EXACT_SIZE;
    b"mw"         , [0xDE              ], 6, FPU;
]
"fidivr" = [
    b"md"         , [0xDA              ], 7, FPU | EXACT_SIZE;
    b"mw"         , [0xDE              ], 7, FPU;
]
"fild" = [
    b"md"         , [0xDB              ], 0, FPU | EXACT_SIZE;
    b"mq"         , [0xDF              ], 5, FPU | EXACT_SIZE;
    b"mw"         , [0xDF              ], 0, FPU;
]
"fimul" = [
    b"md"         , [0xDA              ], 1, FPU | EXACT_SIZE;
    b"mw"         , [0xDE              ], 1, FPU;
]
"fincstp" = [
    b""           , [0xD9, 0xF7        ], X, FPU;
...
"fist" = [
    b"md"         , [0xDB              ], 2, FPU | EXACT_SIZE;
    b"mw"         , [0xDF              ], 2, FPU;
]
"fistp" = [
    b"md"         , [0xDB              ], 3, FPU | EXACT_SIZE;
    b"mq"         , [0xDF              ], 7, FPU | EXACT_SIZE;
    b"mw"         , [0xDF              ], 3, FPU;
]
"fisttp" = [
    b"md"         , [0xDB              ], 1, FPU | EXACT_SIZE;
    b"mq"         , [0xDD              ], 1, FPU | EXACT_SIZE;
    b"mw"         , [0xDF              ], 1, FPU;
]
"fisub" = [
    b"md"         , [0xDA              ], 4, FPU | EXACT_SIZE;
    b"mw"         , [0xDE              ], 4, FPU;
]
"fisubr" = [
    b"md"         , [0xDA              ], 5, FPU | EXACT_SIZE;
    b"mw"         , [0xDE              ], 5, FPU;
]
"fld" = [
    b""           , [0xD9, 0xC1        ], X, FPU;
    b"fp"         , [0xD9, 0xC0        ], X, SHORT_ARG | FPU;
    b"md"         , [0xD9              ], 0, FPU | EXACT_SIZE;
    b"mp"         , [0xDB              ], 5, FPU | EXACT_SIZE;
    b"mq"         , [0xDD              ], 0, FPU | EXACT_SIZE;
]
"fld1" = [
    b""           , [0xD9, 0xE8        ], X, FPU;
]
...
"fmul" = [
    ...
    b"fpXp"       , [0xDC, 0xC8        ], X, SHORT_ARG | FPU;
    b"md"         , [0xD8              ], 1, FPU | EXACT_SIZE;
    b"mq"         , [0xDC              ], 1, FPU | EXACT_SIZE;
]
"fmulp" = [
    b""           , [0xDE, 0xC9        ], X, FPU;
...
"fst" = [
    ...
    b"md"         , [0xD9              ], 2, FPU | EXACT_SIZE;
    b"mq"         , [0xDD              ], 2, FPU | EXACT_SIZE;
]
"fstcw" = [
...
"fstp" = [
    ...
    b"md"         , [0xD9              ], 3, FPU | EXACT_SIZE;
    b"mp"         , [0xDB              ], 7, FPU | EXACT_SIZE;
    b"mq"         , [0xDD              ], 3, FPU | EXACT_SIZE;
]
"fstsw" = [
...
"fsub" = [
    ...
    b"fpXp"       , [0xDC, 0xE8        ], X, SHORT_ARG | FPU;
    b"md"         , [0xD8              ], 4, FPU | EXACT_SIZE;
    b"mq"         , [0xDC              ], 4, FPU | EXACT_SIZE;
]
"fsubp" = [
    b""           , [0xDE, 0xE9        ], X, FPU;
...
"fsubr" = [
    ...
    b"fpXp"       , [0xDC, 0xE0        ], X, SHORT_ARG | FPU;
    b"md"         , [0xD8              ], 5, FPU | EXACT_SIZE;
    b"mq"         , [0xDC              ], 5, FPU | EXACT_SIZE;
]
"fsubrp" = [
    b""           , [0xDE, 0xE1        ], X, FPU;
...
"pclmulhqlqdq" = [
    b"yowo"       , [0x0F, 0x3A, 0x44, 0x01], X, IMM_OP | PREF_66 | SSE;
]
"pclmullqhqdq" = [
...
"pfrcpv" = [
    b"xquq"       , [0x0F, 0x0F, 0x86  ], X, IMM_OP | CYRIX | TDNOW;
]
"pfrsqit1" = [
...
"pmulhrsw" = [
    b"xquq"       , [0x0F, 0x38, 0x0B  ], X, SSSE3 | MMX;
...
"rsdc" = [
    b"swmp"       , [0x0F, 0x79        ], X, CYRIX | EXACT_SIZE;
]
"rsldt" = [
    b"mp"         , [0x0F, 0x7B        ], 0, CYRIX | EXACT_SIZE;
]
"rsm" = [
    b""           , [0x0F, 0xAA        ], X;
]
...
"rsts" = [
    b"mp"         , [0x0F, 0x7D        ], 0, CYRIX | EXACT_SIZE;
]
"sahf" = [
    b""           , [0x9E              ], X;
]
...
"svdc" = [
    b"mpsw"       , [0x0F, 0x78        ], X, ENC_MR | CYRIX | EXACT_SIZE;
]
"svldt" = [
    b"mp"         , [0x0F, 0x7A        ], 0, CYRIX | EXACT_SIZE;
]
"svts" = [
    b"mp"         , [0x0F, 0x7C        ], 0, CYRIX | EXACT_SIZE;
]
"swapgs" = [
    b""           , [0x0F, 0x01, 0xF8  ], X;
]
...
"vcmpeq_uspd" = [
    b"y*y*w*"     , [0x01, 0xC2, 0x18  ], X, VEX_OP | AUTO_VEXL | IMM_OP | PREF_66 | AVX;
]
"vcmpeq_usps" = [
    b"y*y*w*"     , [0x01, 0xC2, 0x18  ], X, VEX_OP | AUTO_VEXL | IMM_OP | AVX;
]
"vcmpeq_ussd" = [
    b"yoyomq"     , [0x01, 0xC2, 0x18  ], X, VEX_OP | IMM_OP | PREF_F2 | AVX;
    b"yoyoyo"     , [0x01, 0xC2, 0x18  ], X, VEX_OP | IMM_OP | PREF_F2 | AVX;
]
"vcmpeq_usss" = [
    b"yoyomq"     , [0x01, 0xC2, 0x18  ], X, VEX_OP | PREF_F3 | IMM_OP | AVX;
...
"vcmpfalsepd" = [
    ...
    b"yoyowo"     , [0x01, 0xC2, 0x0B  ], X, VEX_OP | PREF_66 | IMM_OP | AVX;
]
"vcmpfalseps" = [
    b"y*y*w*"     , [0x01, 0xC2, 0x0B  ], X, VEX_OP | AUTO_VEXL | IMM_OP | AVX;
]
...
"vcmpge_oqpd" = [
    b"yhyhwh"     , [0x01, 0xC2, 0x1D  ], X, WITH_VEXL | VEX_OP | IMM_OP | PREF_66 | AVX;
    b"yoyowo"     , [0x01, 0xC2, 0x1D  ], X, VEX_OP | PREF_66 | IMM_OP | AVX;
]
"vcmpge_oqps" = [
    b"y*y*w*"     , [0x01, 0xC2, 0x1D  ], X, VEX_OP | AUTO_VEXL | IMM_OP | AVX;
]
"vcmpge_oqsd" = [
    b"yoyomq"     , [0x01, 0xC2, 0x1D  ], X, VEX_OP | PREF_F2 | IMM_OP | AVX;
    b"yoyoyo"     , [0x01, 0xC2, 0x1D  ], X, VEX_OP | PREF_F2 | IMM_OP | AVX;
]
"vcmpge_oqss" = [
...
"vcmpgt_oqsd" = [
    b"yoyomq"     , [0x01, 0xC2, 0x1E  ], X, VEX_OP | IMM_OP | PREF_F2 | AVX;
...
"vcmplt_oqpd" = [
    b"yhyhwh"     , [0x01, 0xC2, 0x11  ], X, WITH_VEXL | VEX_OP | IMM_OP | PREF_66 | AVX;
    b"yoyowo"     , [0x01, 0xC2, 0x11  ], X, VEX_OP | PREF_66 | IMM_OP | AVX;
]
"vcmplt_oqps" = [
...
"vcmplt_ossd" = [
    b"yoyomq"     , [0x01, 0xC2, 0x01  ], X, VEX_OP | IMM_OP | PREF_F2 | AVX;
    b"yoyoyo"     , [0x01, 0xC2, 0x01  ], X, VEX_OP | IMM_OP | PREF_F2 | AVX;
]
"vcmplt_osss" = [
...
"vcmpneq_oqpd" = [
    b"y*y*w*"     , [0x01, 0xC2, 0x0C  ], X, VEX_OP | AUTO_VEXL | IMM_OP | PREF_66 | AVX;
]
"vcmpneq_oqps" = [
...
"vcmpneq_ossd" = [
    b"yoyomq"     , [0x01, 0xC2, 0x1C  ], X, VEX_OP | IMM_OP | PREF_F2 | AVX;
    b"yoyoyo"     , [0x01, 0xC2, 0x1C  ], X, VEX_OP | IMM_OP | PREF_F2 | AVX;
]
"vcmpneq_osss" = [
    b"yoyomq"     , [0x01, 0xC2, 0x1C  ], X, VEX_OP | PREF_F3 | IMM_OP | AVX;
    b"yoyoyo"     , [0x01, 0xC2, 0x1C  ], X, VEX_OP | PREF_F3 | IMM_OP | AVX;
]
"vcmpneq_uqpd" = [
...
"vcmpneq_uspd" = [
    b"y*y*w*"     , [0x01, 0xC2, 0x14  ], X, VEX_OP | AUTO_VEXL | IMM_OP | PREF_66 | AVX;
]
"vcmpneq_usps" = [
...
"vcmpnge_uqpd" = [
    b"yhyhwh"     , [0x01, 0xC2, 0x19  ], X, WITH_VEXL | VEX_OP | PREF_66 | IMM_OP | AVX;
    b"yoyowo"     , [0x01, 0xC2, 0x19  ], X, VEX_OP | IMM_OP | PREF_66 | AVX;
]
"vcmpnge_uqps" = [
...
"vcmpnge_uqss" = [
    b"yoyomq"     , [0x01, 0xC2, 0x19  ], X, VEX_OP | PREF_F3 | IMM_OP | AVX;
...
"vcmpnle_uqpd" = [
    b"y*y*w*"     , [0x01, 0xC2, 0x16  ], X, VEX_OP | AUTO_VEXL | IMM_OP | PREF_66 | AVX;
]
"vcmpnle_uqps" = [
...
"vcmpnlt_uqsd" = [
    b"yoyomq"     , [0x01, 0xC2, 0x15  ], X, VEX_OP | PREF_F2 | IMM_OP | AVX;
    b"yoyoyo"     , [0x01, 0xC2, 0x15  ], X, VEX_OP | PREF_F2 | IMM_OP | AVX;
]
"vcmpnlt_uqss" = [
...
"vcmpnlt_uspd" = [
    b"yhyhwh"     , [0x01, 0xC2, 0x05  ], X, WITH_VEXL | VEX_OP | IMM_OP | PREF_66 | AVX;
    b"yoyowo"     , [0x01, 0xC2, 0x05  ], X, VEX_OP | PREF_66 | IMM_OP | AVX;
]
"vcmpnlt_usps" = [
...
"vcmpord_ssd" = [
    b"yoyomq"     , [0x01, 0xC2, 0x17  ], X, VEX_OP | PREF_F2 | IMM_OP | AVX;
    b"yoyoyo"     , [0x01, 0xC2, 0x17  ], X, VEX_OP | PREF_F2 | IMM_OP | AVX;
]
"vcmpord_sss" = [
    b"yoyomq"     , [0x01, 0xC2, 0x17  ], X, VEX_OP | IMM_OP | PREF_F3 | AVX;
...
"vcmptrue_uqpd" = [
    b"yhyhwh"     , [0x01, 0xC2, 0x0F  ], X, WITH_VEXL | VEX_OP | PREF_66 | IMM_OP | AVX;
    b"yoyowo"     , [0x01, 0xC2, 0x0F  ], X, VEX_OP | IMM_OP | PREF_66 | AVX;
]
"vcmptrue_uqps" = [
...
"vcmptrue_uspd" = [
    b"yhyhwh"     , [0x01, 0xC2, 0x1F  ], X, WITH_VEXL | VEX_OP | IMM_OP | PREF_66 | AVX;
    b"yoyowo"     , [0x01, 0xC2, 0x1F  ], X, VEX_OP | PREF_66 | IMM_OP | AVX;
]
"vcmptrue_usps" = [
...
"vcmptruesd" = [
    b"yoyomq"     , [0x01, 0xC2, 0x0F  ], X, VEX_OP | IMM_OP | PREF_F2 | AVX;
...
"vfmsubss" = [
    b"yoyomdyo"   , [0x03, 0x6E        ], X, VEX_OP | PREF_66 | SSE5 | AMD;
...
"vfnmsubps" = [
    b"y*y*y*w*"   , [0x03, 0x7C        ], X, VEX_OP | AUTO_VEXL | PREF_66 | AMD | SSE5;
...
"vfrczpd" = [
    b"y*w*"       , [0x09, 0x81        ], X, XOP_OP | AUTO_VEXL | AMD | SSE5;
]
"vfrczps" = [
...
"vpclmullqhqdq" = [
    b"yoyowo"     , [0x03, 0x44, 0x10  ], X, VEX_OP | PREF_66 | IMM_OP | AVX;
]
"vpclmullqlqdq" = [
...
"vpcmov" = [
    b"y*y*w*y*"   , [0x08, 0xA2        ], X, XOP_OP | AUTO_VEXL | AMD | SSE5;
...
"vpcomd" = [
    b"yoyowoib"   , [0x08, 0xCE        ], X, XOP_OP | SSE5 | AMD;
]
"vpcomq" = [
...
"vphadddq" = [
    b"yowo"       , [0x09, 0xCB        ], X, XOP_OP | AMD | SSE5;
]
"vphaddsw" = [
...
"vphsubwd" = [
    b"yowo"       , [0x09, 0xE2        ], X, XOP_OP | AMD | SSE5;
]
"vpinsrb" = [
...
"vpmacsswd" = [
    b"yoyowoyo"   , [0x08, 0x86        ], X, XOP_OP | SSE5 | AMD;
]
"vpmacssww" = [
    b"yoyowoyo"   , [0x08, 0x85        ], X, XOP_OP | AMD | SSE5;
]
"vpmacswd" = [
    b"yoyowoyo"   , [0x08, 0x96        ], X, XOP_OP | AMD | SSE5;
]
"vpmacsww" = [
...
"vprotb" = [
    ...
    b"yowoyo"     , [0x09, 0x90        ], X, XOP_OP | ENC_MR | SSE5 | AMD;
    b"yoyowo"     , [0x09, 0x90        ], X, WITH_REXW | XOP_OP | SSE5 | AMD;
]
"vprotd" = [
    b"yowoib"     , [0x08, 0xC2        ], X, XOP_OP | SSE5 | AMD;
    b"yowoyo"     , [0x09, 0x92        ], X, XOP_OP | ENC_MR | SSE5 | AMD;
...
"vpshab" = [
    b"yowoyo"     , [0x09, 0x98        ], X, XOP_OP | ENC_MR | SSE5 | AMD;
    b"yoyowo"     , [0x09, 0x98        ], X, WITH_REXW | XOP_OP | AMD | SSE5;
]
"vpshad" = [
...
"vpshaq" = [
    b"yowoyo"     , [0x09, 0x9B        ], X, XOP_OP | ENC_MR | AMD | SSE5;
    b"yoyowo"     , [0x09, 0x9B        ], X, WITH_REXW | XOP_OP | SSE5 | AMD;
]
"vpshaw" = [
    b"yowoyo"     , [0x09, 0x99        ], X, XOP_OP | ENC_MR | AMD | SSE5;
    b"yoyowo"     , [0x09, 0x99        ], X, WITH_REXW | XOP_OP | AMD | SSE5;
]
"vpshlb" = [
