...
] "fucomip"     = [ b"Xpfp",     [0xDF, 0xE8      ], X, SHORT_ARG;
] "fwait"       |
  "wait"        = [ b"",         [0x9B            ], X;
] "fxam"        = [ b"",         [0xD9, 0xE5      ], X;
] "fxch"        = [ b"",         [0xD9, 0xC9      ], X;
...
] "cvtpd2ps"    = [ b"yowo",     [0x0F, 0x5A      ], X, PREF_66;
] "vcvtpd2ps"   = [ b"y*w*",     [   1, 0x5A      ], X, PREF_66 | AUTO_VEXL | VEX_OP;
...
] "palignr"     = [ b"y*w*ib",   [0x0F, 0x3A, 0x0F], X, PREF_66;
] "vpalignr"    = [ b"y*y*w*ib", [   3, 0x0F      ], X, PREF_66 | AUTO_VEXL | VEX_OP;
...
] "pblendw"     = [ b"yowoib",   [0x0F, 0x3A, 0x0E], X, PREF_66;
] "vpblendw"    = [ b"y*y*w*ib", [   3, 0x0E      ], X, PREF_66 | AUTO_VEXL | VEX_OP;
...
] "pshufhw"     = [ b"yowoib",   [0x0F, 0x70      ], X, PREF_F3;
] "vpshufhw"    = [ b"y*w*ib",   [   1, 0x70      ], X, PREF_F3 | AUTO_VEXL | VEX_OP;
...
] "vucomisd"    = [ b"yoyo",     [   1, 0x2E      ], X, PREF_66             | VEX_OP;
                    b"yomq",     [   1, 0x2E      ], X, PREF_66             | VEX_OP;
] "ucomiss"     = [ b"yoyo",     [0x0F, 0x2E      ], X;
                    b"yomd",     [0x0F, 0x2E      ], X;
] "vucomiss"    = [ b"yoyo",     [   1, 0x2E      ], X,                       VEX_OP;
                    b"yomd",     [   1, 0x2E      ], X,                       VEX_OP;
...
] "vfmaddsubpd"   =[b"y*y*w*y*", [   3, 0x5D      ], X, PREF_66 | AUTO_VEXL | VEX_OP;
